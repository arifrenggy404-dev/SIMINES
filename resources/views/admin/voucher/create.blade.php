...
<head>
    ...
    <title>Tambah Voucher - SIMINES Admin</title>
            ...
            <div class="form-container shadow-sm">
                <form action="{{ route('admin.voucher.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode" id="kode" class="form-control @error('kode') is-invalid @enderror" placeholder="Contoh: MERDEKA10" value="{{ old('kode') }}" required>
                        @error('kode') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    
                    <div class="mb-3">
                        <label for="potongan_harga" class="form-label">Potongan Harga (Rp)</label>
                        <input type="number" name="potongan_harga" id="potongan_harga" class="form-control @error('potongan_harga') is-invalid @enderror" placeholder="Contoh: 5000" value="{{ old('potongan_harga') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="minimal_belanja" id="minimal_belanja" class="form-control @error('minimal_belanja') is-invalid @enderror" placeholder="Contoh: 20000" value="{{ old('minimal_belanja', 0) }}" required>
