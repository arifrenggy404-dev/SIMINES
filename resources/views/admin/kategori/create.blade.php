...
<head>
    ...
    <title>Tambah Kategori - SIMINES Admin</title>
    ...
    <style>
        ...
        .form-container { background: white; border-radius: 10px; padding: 30px; max-width: 500px; margin: auto; }
    </style>
</head>
<body>
...
<div class="d-flex">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="mb-4">
                <a href="{{ route('admin.kategori.index') }}" class="btn btn-outline-secondary btn-sm mb-2"><i class="bi bi-arrow-left"></i> Kembali</a>
            ...
            <div class="form-container shadow-sm">
                <form action="{{ route('admin.kategori.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_kategori" id="nama_kategori" class="form-control @error('nama_kategori') is-invalid @enderror" placeholder="Contoh: Minuman Boba" value="{{ old('nama_kategori') }}" required autofocus>
